...
from rgm.utils.random import uniform_2_sphere
from rgm.utils.config import cfg
import rgm.utils.se3 as se3
import rgm.utils.so3 as so3
    ...
    def __call__(self, sample):
        if 'points' in sample:
            ...
            if 'jitterflag' in sample or 'corpflag' in sample:
                ...
                # Double-sided corresponding filling, complete filling, double-sided corresponding filling + partial corresponding filling
                padth = 0.05
                if padtype==1:
